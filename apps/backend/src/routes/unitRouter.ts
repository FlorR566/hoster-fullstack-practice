...
router.post(
	"/create-unit",
	body("type").notEmpty().withMessage("El tipo de unidad no puede estar vacio"),
	body("capacity")
		.notEmpty()
		.withMessage("La cantidad de unidades no puede estar vacia"),
	handleInputErrors,
	UnitController.createUnit,
);

router.get("/get-units", handleInputErrors, UnitController.getAllUnit);
